...
public class ConcurrentHashMap<K,V> extends AbstractMap<K,V>
    ...
    static final int spread(int h) {
        ...
        // 前面和hashMap的计算一样 & HASH_BITS 保证它永远为正数
                        ...
                        if (fh >= 0) {
                            ...
                            for (Node<K,V> e = f;; ++binCount) {
                                ...
                                if (e.hash == hash &&
                                    ...
                                    if (!onlyIfAbsent)
                                        e.val = value;
                                    // 直接跳出，这是一种思想。在编程时可以减少一些if else判断
                                    break;
                                }
                                Node<K,V> pred = e;
